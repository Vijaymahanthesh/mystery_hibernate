...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#9368f3','#3c86d8','#3ec396'];
		...
		var colors = ['#5d6dc3','#3ec396','#f36270','#313a46'];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#3c86d8']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutdatas = [35, 20, 10, 20];
		var donutcolors = ['#9368f3','#3c86d8','#3ec396','#4fbde9'];
		this.createDonutGraph("#donut-chart1 #donut-chart-container1", donutlabels, donutdatas, donutcolors);
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#3c86d8', '#f9bc0b', "#ebeff2"], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ["#9368f3", "#f9bc0b"], line_data);
	},
