                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/saveBrand" autocomplete="off">
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required   class="form-control" onkeyup="checkBrandExist(this.value)" id="brand_name" name="brand_name" placeholder="Enter Brand Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                    ...
                    <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tr>
                                    <td>${brandBean.brand_name}</td>
                                      <td>${brandBean.brand_description }</td>
                                    <td><a href="${pageContext.request.contextPath}/editBrand/${brandBean.sk_brand_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${brandBean.sk_brand_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="brandBean" items="${inactiveBrandList}">
                                <tr>
                                   <td>${brandBean.brand_name}</td>
                                      <td>${brandBean.brand_description}</td>
                                    <td><a href="#"  title="Restore the Brand" class="mdi mdi-backup-restore" data-restoreid="${brandBean.sk_brand_id}" data-toggle="modal" data-target="#myModal1"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
    	  ...
    	  var brand_name=$("#brand_name").val();
      	 $.ajax({
               ...
               success: function(response)
					   ...
					   {
						   $("#branderrormsg").text("Brand already exists in Inactive tab Please restore it ...!")
					   }
