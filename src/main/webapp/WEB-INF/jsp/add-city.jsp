...
<html>
       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/saveCity" autocomplete="off">
                                <div class="form-group col-md-12">
                                    ...
                                    <c:forEach var="city" items="${activeStateList}">
                                     <option value="${city.sk_state_id }">${city.state_name}</option>
                                     </c:forEach>
                                     </select>                           
                                 </div>
                                 <div class="form-group col-md-12">
                                    <label for="state_name">City Name<span class="text-danger">*</span></label>
                                    <input type="text" required   class="form-control" onkeyup="checkCityExistOrNot(this.value)" id="city_name" name="city_name" placeholder="Enter City Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required   class="form-control" id="tier" name="tier" placeholder="Enter Tier"   data-parsley-maxlength="100">
                                </div>
                                 <div class="form-group col-md-12">
                                    <label for="state_name">Metro<span class="text-danger">*</span></label>
                                    <input type="text" required   class="form-control"  id="metro" name="metro" placeholder="Enter Metro"   data-parsley-maxlength="100">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                <c:forEach var="city" items="${cityActiveList}">
                                <tr>
                                    <td>${city.state.state_name }</td>
                                      <td>${city.city_name}</td>
                                      <td>${city.tier }</td>
                                      <td>${city.metro }</td>
                                    <td><a href="${pageContext.request.contextPath}/editCity/${city.sk_city_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${city.sk_city_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="city" items="${inactiveCityList}">
                                <tr>
                                   <td>${city.state.state_name}</td>
                                      <td>${city.city_name}</td>
                                       <td>${city.tier}</td>
                                      <td>${city.metro}</td>
                                    <td><a href="#"  title="Restore the City" class="mdi mdi-backup-restore" data-restoreid="${city.sk_city_id}" data-toggle="modal" data-target="#myModal1"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script type="text/javascript">
            ...
            $(".fa-trash").on("click",function(){
            	...
            	var url="${pageContext.request.contextPath}/deleteCity/"+value;
            	$(".btn-edit").attr("href",url);
            })
             $(".mdi-backup-restore").on("click",function(){
            	var value=$(this).attr("data-restoreid");
            	var url="${pageContext.request.contextPath}/restoreCity/"+value;
	...
	jQuery('#city_name').keyup(function() 
	{
      ...
      <script type="text/javascript">
      function checkCityExistOrNot(city_name){
    	  var state_id=$("#state_id").val();
      	 $.ajax({
               url: "${pageContext.request.contextPath}/checkCityExistOrNot",
               type: "GET", 
               ...
               success: function(response)
				   ...
				   if(statusCode=="1" && status=="active"){
					   $("#cityerrormessage").text("City already exists ...!")
				   }
				   else if(statusCode=="0" && status=="inactive")
				   {
					   $("#cityerrormessage").text("City already exists in Inactive tab Please restore it ...!")
				   }
