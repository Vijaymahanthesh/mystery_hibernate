                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/saveRegion"autocomplete="off">
                                <div class="form-group col-md-12">
                                    ...
                                    <c:forEach var="region" items="${cityActiveList}">
                                     <option value="${region.sk_city_id }">${region.city_name }</option>
                                     </c:forEach>
                                     </select>  
                                     <div id="chke"></div>                         
                                 </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required onkeyup="CheckRegionExistOrNot(this.value)"  class="form-control" id="region_name" name="region_name" placeholder="Enter Region Name"  data-parsley-maxlength="100" >
                    ...
                    <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                 <c:forEach var="region" items="${activeRegionList}"> 
                                <tr>
                                   <td>${region.region_name}</td>
                                  <td>${region.city.city_name}</td>
                                    <td><a href="${pageContext.request.contextPath}/editRegion/${region.sk_region_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${region.sk_region_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                 </c:forEach> 
                                </tbody>
                            </table> 
                                ...
                                <tbody>
                                  <c:forEach var="region" items="${inactiverRegionList}"> 
                                <tr>
                                 <td>${region.region_name}</td>
                                    <td>${region.city.city_name}</td>
                                    <td><a href="#"  title="Restore the Region" class="mdi mdi-backup-restore" data-restoreid="${region.sk_region_id}" data-toggle="modal" data-target="#myModal1"></a></td>
                                </tr>
                                 </c:forEach>
                                </tbody>
                            </table> 
