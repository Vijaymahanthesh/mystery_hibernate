       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="saveState" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="state_name">State Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" onkeyup="checkStateExistOrNot(this.value)" id="state_name" name="state_name" placeholder="Enter State Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                     ...
                     <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                <c:forEach var="state" items="${activeStateList}">
                                <tr>
                                    <td>${state.state_name }</td>
                                    <td><a href="${pageContext.request.contextPath}/editState/${state.sk_state_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${state.sk_state_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="state" items="${inactiveStateList}">
                                <tr>
                                    <td>${state.state_name }</td>
                                    <td><a href="#" data-restoreid="${state.sk_state_id}" data-toggle="modal" data-target="#myModal1" title="Restore the State" class="mdi mdi-backup-restore"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
