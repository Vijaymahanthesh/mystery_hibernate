                        ...
                        <div class="card-box ">
                            ...
                            <div class="form-group col-md-12">
									...
									<option value="" >Select Brand</option>
									  ...
									  <option value="${brandBean.sk_brand_id}">${brandBean.brand_name}</option>
									  </c:forEach>
                                     </select>                           
                                 </div>
                                <div class="form-group col-md-12">
                                    <label for="state_name">Model Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control"  onkeyup="modelExistOrNot(this.value)" id="model_name" name="model_name" placeholder="Enter Model Name"   data-parsley-maxlength="100">
                     ...
                     <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tr>
                                    <td>${modelBean.brand.brand_name }</td>
                                    <td>${modelBean.model_name }</td>
                                    <td><a href="${pageContext.request.contextPath}/editModel/${modelBean.sk_model_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${modelBean.sk_model_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="modelBean" items="${inactiveModelList}">
                                <tr>
                                    <td>${modelBean.brand.brand_name }</td>
                                    <td>${modelBean.model_name }</td>
                                    <td><a href="#" data-restoreid="${modelBean.sk_model_id}" data-toggle="modal" data-target="#myModal1" title="Restore the State" class="mdi mdi-backup-restore"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
