                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/saveSubsection"  autocomplete="off">
                                <div class="form-group col-md-12">
                                   ...
                                   <select id="section_id" name="section_id" required class="form-control"  >
                                      ...
                                      <option value="${section.sk_section_id}" <c:if test = "${section.sk_section_id == subsectionDetails.section_id}">selected </c:if>>${section.section_name}</option>                                     </c:forEach> 
                                     </select>      
                                </div>
                                
                                <div class="form-group col-md-12">
                                    <label for="state_name"> Sub Section Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" onkeyup="checkSubsectionExistOrNot(this.value)" id="subsection_name" name="subsection_name"  value="${subsectionDetails.subsection_name}"placeholder="Enter Sub Section Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                                    <input type="hidden"  class="form-control"  id="sk_subsection_id" name="sk_subsection_id"  value="${subsectionDetails.sk_subsection_id}"placeholder="Enter Sub Section Name">
                                ...
                                <div class="form-group text-right m-b-0">
                                  ...
                                  <a href="${pageContext.request.contextPath}/addSubsection"><button type="submit" id="reset" class="btn btn-light waves-effect m-l-5" id="reset" >
                                        Cancel
                                    </button></a>
